...
def login_lagi334():
	...
	if pil in ['1','01']:
		try:
			...
			head = {'User-Agent': 'Mozilla/5.0 (Windows NT 6.3; WOW64) AppleWebKit/537.36+ (KHTML, like Gecko) Chrome/45.0.2454.85 Safari/537.36+'}
...
def dump_pengikut():
	try:
		token = open('data/proxy.txt","w').read()
	except IOError:
		exit()
